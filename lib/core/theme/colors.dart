...
class AppColors {
  ...
  static const lightOnBackground = Color(
    0xFF262626,
  ); // Text on background
  ...
  static const lightOnPrimaryColor = Color(
    0xFFFFFFFF,
  ...
  static const lightOnTertiary = Color(
    0xFFFFFFFF,
  );

  // Error and Utility
  static const lightError = Color(
    0xFFD4183D,
  );
  static const lightOnError = Color(
    0xFFFFFFFF,
  );
  static const lightOutline = Color(
    0xFFE6E6E6,
  ); // Border color
  static const lightInputFill = Color(
    0xFFF3F3F5,
  ); // Input fill color
  static const lightRing = Color(
    0xFFB5B5B5,
  );

  // App-specific Colors (AppBar, Sidebar, NavBar)
  static const lightAppSurface = Color(
    0xFF1447E6,
  ); // AppBar/Sidebar background
  static const lightOnAppSurface = Color(
    0xFFFFFFFF,
  ); // Text on AppBar/Sidebar
  ...
  static const darkOnBackground = Color(
    0xFFFAFAFA,
  );
  ...
  static const darkSurfaceVariant = Color(
    0xFF959AA5,
  ); // Muted surface
  ...
  static const darkOnTertiary = Color(
    0xFF1A1A1A,
  );

  // Error and Utility
  static const darkError = Color.fromARGB(255, 209, 84, 84);
  static const darkOnError = Color(
    0xFFD4A5A5,
  );
  static const darkOutline = Color(
    0xFF4A5565,
  ); // Border color
  static const darkInputFill = Color(
    0xFF364153,
  ); // Input fill color
  static const darkRing = Color(
    0xFF707070,
  );

  // App-specific Colors (AppBar, Sidebar, NavBar)
  static const darkAppSurface = Color(
    0xFF1447E6,
  ); // AppBar/Sidebar background
  static const darkOnAppSurface = Color(
    0xFFFAFAFA,
  ); // Text on AppBar/Sidebar
}
